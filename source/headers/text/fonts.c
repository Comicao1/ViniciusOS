...
uint8* vga = (unsigned char*)0xA0000;
...
void draw_char(int32 x, int32 y, int8 c, int32 color) {
    for (int32 row = 0; row < 8; row++) {
        uint8 byte = font8x8_basic[(uint8)c][row];
...
void clear_buffer(uint8 color) {
    ...
    uint32* buffer32 = (uint32*)vga;
    int32 total_dwords = (320 * 200) / 4;

    for (int32 i = 0; i < total_dwords; i++) {
        vga[i] = color32;
    }
